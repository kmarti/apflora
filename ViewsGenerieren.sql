...
bisher:
SELECT tblAktionsplan.ApArtId, ArtenDb_tblFloraSisf.Name, DomainApBearbeitungsstand.DomainTxt AS "Bearbeitungsstand AP", tblPopulation.PopId, tblPopulation.PopNr, tblPopulation.PopName, tblTeilpopulation.TPopId, tblTeilpopulation.TPopNr, DomainPopHerkunft.HerkunftTxt AS TPopHerkunft, tblTeilpopulation.TPopGemeinde, tblTeilpopulation.TPopFlurname, tblTeilPopFeldkontrolle.TPopKontrId, tblTeilPopFeldkontrolle.TPopKontrTyp, tblTeilPopFeldkontrolle.TPopKontrDatum, tblTeilPopFeldkontrolle.TPopKontrJahr, tblAdresse.AdrName AS TPopKontrBearb, DomainTPopKontrZaehleinheit.ZaehleinheitTxt AS TPopKontrZaehleinheit1, DomainTPopKontrMethode.BeurteilTxt AS TPopKontrMethode1, tblTeilPopFeldkontrolle.TPopKontrAnz1, DomainTPopKontrZaehleinheit_1.ZaehleinheitTxt AS TPopKontrZaehleinheit2, DomainTPopKontrMethode_1.BeurteilTxt AS TPopKontrMethode2, tblTeilPopFeldkontrolle.TPopKontrAnz2, DomainTPopKontrZaehleinheit_2.ZaehleinheitTxt AS TPopKontrZaehleinheit3, DomainTPopKontrMethode_2.BeurteilTxt AS TPopKontrMethode3, tblTeilPopFeldkontrolle.TPopKontrAnz3, tblTeilPopFeldkontrolle.TPopKontrJungpfl, tblTeilPopFeldkontrolle.TPopKontrVitalitaet, tblTeilPopFeldkontrolle.TPopKontrUeberleb, DomainTPopEntwicklung.EntwicklungTxt AS TPopKontrEntwicklung, tblTeilPopFeldkontrolle.TPopKontrUrsach, tblTeilPopFeldkontrolle.TPopKontrUrteil, tblTeilPopFeldkontrolle.TPopKontrAendUms, tblTeilPopFeldkontrolle.TPopKontrAendKontr, tblTeilPopFeldkontrolle.TPopKontrTxt, tblTeilPopFeldkontrolle.TPopKontrLeb, tblTeilPopFeldkontrolle.TPopKontrFlaeche, tblTeilPopFeldkontrolle.TPopKontrLebUmg, tblTeilPopFeldkontrolle.TPopKontrStrauchschicht, tblTeilPopFeldkontrolle.TPopKontrBodenTyp, tblTeilPopFeldkontrolle.TPopKontrBodenAbtrag, tblTeilPopFeldkontrolle.TPopKontrWasserhaushalt, tblTeilPopFeldkontrolle.TPopKontrHandlungsbedarf, tblTeilPopFeldkontrolle.TPopKontrübFläche, tblTeilPopFeldkontrolle.TPopKontrPlan, tblTeilPopFeldkontrolle.TPopKontrVeg, tblTeilPopFeldkontrolle.TPopKontrNaBo, tblTeilPopFeldkontrolle.TPopKontrübPfl, tblTeilPopFeldkontrolle.TPopKontrJungPflJN, tblTeilPopFeldkontrolle.TPopKontrVegHöMax, tblTeilPopFeldkontrolle.TPopKontrVegHöMit, tblTeilPopFeldkontrolle.TPopKontrGefährdung, tblTeilPopFeldkontrolle.TPopKontrMutDat
FROM qryAuswLetzteAnzahlLetzteKontrolle INNER JOIN ((((((((((((ArtenDb_tblFloraSisf INNER JOIN tblAktionsplan ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) INNER JOIN (tblPopulation INNER JOIN (tblTeilpopulation INNER JOIN tblTeilPopFeldkontrolle ON tblTeilpopulation.TPopId = tblTeilPopFeldkontrolle.TPopId) ON tblPopulation.PopId = tblTeilpopulation.PopId) ON tblAktionsplan.ApArtId = tblPopulation.ApArtId) LEFT JOIN DomainApBearbeitungsstand ON tblAktionsplan.ApStatus = DomainApBearbeitungsstand.DomainCode) LEFT JOIN tblAdresse ON tblTeilPopFeldkontrolle.TPopKontrBearb = tblAdresse.AdrId) LEFT JOIN DomainTPopKontrZaehleinheit ON tblTeilPopFeldkontrolle.TPopKontrZaehleinheit1 = DomainTPopKontrZaehleinheit.ZaehleinheitCode) LEFT JOIN DomainTPopKontrMethode ON tblTeilPopFeldkontrolle.TPopKontrMethode1 = DomainTPopKontrMethode.BeurteilCode) LEFT JOIN DomainTPopKontrZaehleinheit AS DomainTPopKontrZaehleinheit_1 ON tblTeilPopFeldkontrolle.TPopKontrZaehleinheit2 = DomainTPopKontrZaehleinheit_1.ZaehleinheitCode) LEFT JOIN DomainTPopKontrMethode AS DomainTPopKontrMethode_1 ON tblTeilPopFeldkontrolle.TPopKontrMethode2 = DomainTPopKontrMethode_1.BeurteilCode) LEFT JOIN DomainTPopKontrZaehleinheit AS DomainTPopKontrZaehleinheit_2 ON tblTeilPopFeldkontrolle.TPopKontrZaehleinheit3 = DomainTPopKontrZaehleinheit_2.ZaehleinheitCode) LEFT JOIN DomainTPopKontrMethode AS DomainTPopKontrMethode_2 ON tblTeilPopFeldkontrolle.TPopKontrMethode3 = DomainTPopKontrMethode_2.BeurteilCode) LEFT JOIN DomainTPopEntwicklung ON tblTeilPopFeldkontrolle.TPopKontrEntwicklung = DomainTPopEntwicklung.EntwicklungCode) LEFT JOIN DomainPopHerkunft ON tblTeilpopulation.TPopHerkunft = DomainPopHerkunft.HerkunftId) ON qryAuswLetzteAnzahlLetzteKontrolle.MaxvonTPopKontrId = tblTeilPopFeldkontrolle.TPopKontrId
ORDER BY ArtenDb_tblFloraSisf.Name, tblPopulation.PopNr, tblTeilpopulation.TPopNr, tblTeilPopFeldkontrolle.TPopKontrJahr DESC;
...
SELECT ArtenDb_tblFloraSisf.Name, tblAktionsplan.ApStatus, DomainTPopKontrZaehleinheit.ZaehleinheitTxt AS Zähleinheit, Sum(qryAuswLetzteAnzAnz.Anzahl) AS Anzahl
...
SELECT ArtenDb_tblFloraSisf.Name, tblAktionsplan.ApStatus, tblPopulation.PopNr, tblPopulation.PopName, qryAuswLetzteAnzAnz.Zaehleinheit AS Zähleinheit, Sum(qryAuswLetzteAnzAnz.Anzahl) AS Anzahl
...
CREATE VIEW qryGisMassnahmen AS
SELECT tblTeilPopMassnahme.TPopMassnId, tblTeilPopMassnahme.TPopMassnGuid, ArtenDb_tblFloraSisf.Name AS Art, DomainApBearbeitungsstand.DomainTxt AS ApStatus, tblAktionsplan.ApJahr, DomainApUmsetzung.DomainTxt AS ApUmsetzungsstand, tblPopulation.PopNr, tblPopulation.PopName, DomainPopHerkunft.HerkunftTxt AS PopHerkunft, tblPopulation.PopBekanntSeit, tblTeilpopulation.TPopNr, tblTeilpopulation.TPopFlurname, tblTeilpopulation.TPopXKoord, tblTeilpopulation.TPopYKoord, DomainPopHerkunft_1.HerkunftTxt AS TPopHerkunft, tblTeilpopulation.TPopBekanntSeit, tblTeilpopulation.TPopBeschr, tblTeilPopMassnahme.TPopMassnJahr, DomainTPopMassnTyp.MassnTypTxt AS Massnahme, tblTeilPopMassnahme.TPopMassnTxt, tblTeilPopMassnahme.TPopMassnDatum, tblAdresse.AdrName AS TPopMassnBearb, tblTeilPopMassnahme.TPopMassnBemTxt, tblTeilPopMassnahme.TPopMassnPlan, tblTeilPopMassnahme.TPopMassnPlanBez, tblTeilPopMassnahme.TPopMassnFlaeche, tblTeilPopMassnahme.TPopMassnMarkierung, tblTeilPopMassnahme.TPopMassnAnsiedAnzTriebe, tblTeilPopMassnahme.TPopMassnAnsiedAnzPfl, tblTeilPopMassnahme.TPopMassnAnzPflanzstellen, tblTeilPopMassnahme.TPopMassnAnsiedWirtspfl, tblTeilPopMassnahme.TPopMassnAnsiedHerkunftPop, tblTeilPopMassnahme.TPopMassnAnsiedDatSamm, tblTeilPopMassnahme.TPopMassnAnsiedForm, tblTeilPopMassnahme.TPopMassnAnsiedPflanzanordnung
...
FROM (tblAktionsplan INNER JOIN ((tblPopulation INNER JOIN tblTeilpopulation ON tblPopulation.PopId = tblTeilpopulation.PopId) LEFT JOIN tblTeilPopMassnahme ON tblTeilpopulation.TPopId = tblTeilPopMassnahme.TPopId) ON tblAktionsplan.ApArtId = tblPopulation.ApArtId) LEFT JOIN tblKonstanten ON tblTeilPopMassnahme.TPopMassnJahr = tblKonstanten.ApBerJahr
...
CREATE VIEW qryAnzMassnProArtBisJahr AS 
SELECT qryAnzMassnProArtBisJahr0.ApArtId, Count(qryAnzMassnProArtBisJahr0.TPopMassnId) AS AnzahlvonTPopMassnId
...
SELECT tblApBericht.*, If(ArtenDb_tblFloraSisf.Deutsch is null,ArtenDb_tblFloraSisf.Name, CONCAT(ArtenDb_tblFloraSisf.Name, ' (', ArtenDb_tblFloraSisf.Deutsch, ')')) AS Artname, If(ArtenDb_tblFloraFnsKef.KefArt=-1,"Ja","") AS FnsKefArt2, ArtenDb_tblFloraFnsKef.KefKontrolljahr, If(Round((tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,0)=(tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,"Ja","") AS FnsKefKontrJahr2, qryFnsJahrespflanzen.Jahr AS FnsJahrespflanze, qryFnsJahrespflanzen.Jahresart AS FnsJahrespflanze2, qryAnzMassnProArtBisJahr.AnzahlvonTPopMassnId
...
WHERE (((qryAnzMassnProArtBisJahr.AnzahlvonTPopMassnId)>0) AND ((tblApBericht.ApBerBeurteilung)=1) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;
...
WHERE (((tblAktionsplan.ApStatus) Between 1 And 3) AND ((qryAnzMassnProArtBisJahr_1.AnzahlvonTPopMassnId)=0)) OR (((tblAktionsplan.ApStatus) Between 1 And 3) AND ((qryAnzMassnProArtBisJahr_1.AnzahlvonTPopMassnId) Is Null))
ORDER BY ArtenDb_tblFloraSisf.Name;
...
WHERE (((tblApBericht.ApBerBeurteilung)=5) AND ((qryAnzMassnProArtBisJahr.AnzahlvonTPopMassnId)>0) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;
...
WHERE (((tblApBericht.ApBerBeurteilung)=3) AND ((tblAktionsplan.ApStatus) Between 1 And 3) AND ((qryAnzMassnProArtBisJahr.AnzahlvonTPopMassnId)>0))
ORDER BY ArtenDb_tblFloraSisf.Name;
...
WHERE (((tblApBericht.ApBerBeurteilung)=4) AND ((qryAnzMassnProArtBisJahr.AnzahlvonTPopMassnId)>0) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;

CREATE VIEW qryJbUebUn AS 
SELECT tblApBericht.*, If(ArtenDb_tblFloraSisf.Deutsch is null,ArtenDb_tblFloraSisf.Name, CONCAT(ArtenDb_tblFloraSisf.Name, ' (', ArtenDb_tblFloraSisf.Deutsch, ')')) AS Artname, If(ArtenDb_tblFloraFnsKef.KefArt=-1,"Ja","") AS FnsKefArt2, If(Round((tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,0)=(tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,"Ja","") AS FnsKefKontrJahr2, qryFnsJahrespflanzen.Jahr AS FnsJahrespflanze, qryFnsJahrespflanzen.Jahresart AS FnsJahrespflanze2
FROM (((ArtenDb_tblFloraSisf INNER JOIN (tblAktionsplan INNER JOIN qryApApBerichtRelevant ON tblAktionsplan.ApArtId = qryApApBerichtRelevant.ApArtId) ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) LEFT JOIN qryFnsJahrespflanzen ON tblAktionsplan.ApArtId = qryFnsJahrespflanzen.SisfNr) LEFT JOIN ArtenDb_tblFloraFnsKef ON ArtenDb_tblFloraSisf.NR = ArtenDb_tblFloraFnsKef.SisfNr) INNER JOIN ((tblApBericht INNER JOIN qryAnzMassnProArtBisJahr ON tblApBericht.ApArtId = qryAnzMassnProArtBisJahr.ApArtId) INNER JOIN tblKonstanten ON tblApBericht.ApBerJahr = tblKonstanten.ApBerJahr) ON tblAktionsplan.ApArtId = tblApBericht.ApArtId
WHERE (((tblApBericht.ApBerBeurteilung)=1168274204) AND ((qryAnzMassnProArtBisJahr.AnzahlvonTPopMassnId)>0) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;

CREATE VIEW qryJbUebWe AS 
SELECT tblApBericht.*, If(ArtenDb_tblFloraSisf.Deutsch is null,ArtenDb_tblFloraSisf.Name, CONCAT(ArtenDb_tblFloraSisf.Name, ' (', ArtenDb_tblFloraSisf.Deutsch, ')')) AS Artname, If(ArtenDb_tblFloraFnsKef.KefArt=-1,"Ja","") AS FnsKefArt2, If(Round((tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,0)=(tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,"Ja","") AS FnsKefKontrJahr2, qryFnsJahrespflanzen.Jahr AS FnsJahrespflanze, qryFnsJahrespflanzen.Jahresart AS FnsJahrespflanze2
FROM (((ArtenDb_tblFloraSisf INNER JOIN (tblAktionsplan INNER JOIN qryApApBerichtRelevant ON tblAktionsplan.ApArtId = qryApApBerichtRelevant.ApArtId) ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) LEFT JOIN qryFnsJahrespflanzen ON tblAktionsplan.ApArtId = qryFnsJahrespflanzen.SisfNr) LEFT JOIN ArtenDb_tblFloraFnsKef ON ArtenDb_tblFloraSisf.NR = ArtenDb_tblFloraFnsKef.SisfNr) INNER JOIN ((tblApBericht INNER JOIN qryAnzMassnProArtBisJahr ON tblApBericht.ApArtId = qryAnzMassnProArtBisJahr.ApArtId) INNER JOIN tblKonstanten ON tblApBericht.ApBerJahr = tblKonstanten.ApBerJahr) ON tblAktionsplan.ApArtId = tblApBericht.ApArtId
WHERE (((tblApBericht.ApBerBeurteilung)=6) AND ((qryAnzMassnProArtBisJahr.AnzahlvonTPopMassnId)>0) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;
...
SELECT If(ArtenDb_tblFloraSisf.Deutsch is null,ArtenDb_tblFloraSisf.Name, CONCAT(ArtenDb_tblFloraSisf.Name, ' (', ArtenDb_tblFloraSisf.Deutsch, ')')) AS Artname, qryAnzMassnProArtBisJahr.AnzahlvonTPopMassnId
...
WHERE (((qryAnzMassnProArtBisJahr.AnzahlvonTPopMassnId)>0) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;
...
CREATE VIEW qryZdsfBeobAlle0 AS
SELECT BeobachtungenZdsf_ZdsfBeob.ISFS, BeobachtungenZdsf_ZdsfBeob.NO_NOTE, BeobachtungenZdsf_ZdsfBeob.PROJET, BeobachtungenZdsf_ZdsfBeob.CO_CANTON, BeobachtungenZdsf_ZdsfBeob.NOM_COMMUNE, BeobachtungenZdsf_ZdsfBeob.DESC_LOCALITE, BeobachtungenZdsf_ZdsfBeob.xGIS, BeobachtungenZdsf_ZdsfBeob.yGIS, cast(If(BeobachtungenZdsf_ZdsfBeob.M_Note>0,If(BeobachtungenZdsf_ZdsfBeob.M_Note>9, Concat(BeobachtungenZdsf_ZdsfBeob.J_Note, ".", BeobachtungenZdsf_ZdsfBeob.M_Note, ".",  BeobachtungenZdsf_ZdsfBeob.A_Note),Concat(BeobachtungenZdsf_ZdsfBeob.J_Note, ".0", BeobachtungenZdsf_ZdsfBeob.M_Note, ".",  BeobachtungenZdsf_ZdsfBeob.A_Note)),BeobachtungenZdsf_ZdsfBeob.A_Note) as char(15)) AS Datum, BeobachtungenZdsf_ZdsfBeob.ABONDANCE, BeobachtungenZdsf_ZdsfBeob.PRESENCE, If(BeobachtungenZdsf_ZdsfBeob.PRENOM_PERSONNE_OBS Is Not Null, CONCAT(BeobachtungenZdsf_ZdsfBeob.PRENOM_PERSONNE_OBS, " ", BeobachtungenZdsf_ZdsfBeob.Nom_Personne_Obs),BeobachtungenZdsf_ZdsfBeob.Nom_Personne_Obs) AS Autor, BeobachtungenZdsf_ZdsfBeob.NOM_COMPLET AS Artname, BeobachtungenZdsf_ZdsfBeob.Vk, BeobachtungenZdsf_ZdsfBeob.wFN, BeobachtungenZdsf_ZdsfBeob.FN, BeobachtungenZdsf_ZdsfBeob.TY_NOTE, BeobachtungenZdsf_ZdsfBeob.ESTIMATION_DATE, BeobachtungenZdsf_ZdsfBeob.PRECISION_MAILLE, BeobachtungenZdsf_ZdsfBeob.ALTITUDE_INF, BeobachtungenZdsf_ZdsfBeob.CO_MILIEU, BeobachtungenZdsf_ZdsfBeob.STATION, BeobachtungenZdsf_ZdsfBeob.SUBSTRAT, BeobachtungenZdsf_ZdsfBeob.CAT_ABONDANCE, BeobachtungenZdsf_ZdsfBeob.REM_NOTE, BeobachtungenZdsf_ZdsfBeob.NO_PROJET, BeobachtungenZdsf_ZdsfBeob.REM_PROJET, BeobachtungenZdsf_ZdsfBeob.REM_CRSF, CAST(Concat("#http://www.gis.zh.ch/gb/gb.asp?YKoord=", BeobachtungenZdsf_ZdsfBeob.xGIS, "&XKoord=", BeobachtungenZdsf_ZdsfBeob.yGIS, "&Massstab=3000+app=GB-SWISSIMAGE+rn=5$7#") as char(255)) AS lnkGisBrowser
FROM BeobachtungenZdsf_ZdsfBeob
ORDER BY BeobachtungenZdsf_ZdsfBeob.CO_CANTON DESC , BeobachtungenZdsf_ZdsfBeob.NOM_COMMUNE, BeobachtungenZdsf_ZdsfBeob.DESC_LOCALITE, BeobachtungenZdsf_ZdsfBeob.xGIS, BeobachtungenZdsf_ZdsfBeob.yGIS, BeobachtungenZdsf_ZdsfBeob.A_NOTE, BeobachtungenZdsf_ZdsfBeob.M_NOTE, BeobachtungenZdsf_ZdsfBeob.J_NOTE;

CREATE VIEW qryZdsfAnzBeobProArt AS
SELECT tblAktionsplan.ApArtId, Count(BeobachtungenZdsf_ZdsfBeob.NO_NOTE) AS AnzahlZdsfBeob
FROM tblAktionsplan LEFT JOIN BeobachtungenZdsf_ZdsfBeob ON tblAktionsplan.ApArtId = BeobachtungenZdsf_ZdsfBeob.ISFS
GROUP BY tblAktionsplan.ApArtId;

CREATE VIEW qryfrmZdsfBeobAlleArt AS
SELECT tblAktionsplan.ApArtId, Concat(ArtenDb_tblFloraSisf.Name, If(ArtenDb_tblFloraSisf.Deutsch Is Not Null, Concat(" (", ArtenDb_tblFloraSisf.Deutsch, ")"),""), If(ArtenDb_tblFloraSisf.Status="A","",If(ArtenDb_tblFloraSisf.Status="S",". ACHTUNG: Synonym",If(ArtenDb_tblFloraSisf.Status="E",". ACHTUNG: in anderem Taxon eingeschlossener Name",If(ArtenDb_tblFloraSisf.Status="Z",". ACHTUNG: zusammenfassender Name",". ACHTUNG: unbekannter Status des Namens"))))) AS Artname, BeobachtungenZdsf_AnzBeobProArt.AnzahlZdsfBeob AS "Anz ZDSF-Beob", qryZdsfAnzBeobProArtZugewiesen.AnzahlZdsfBeobZugewiesen AS "Davon zugewiesen" 
FROM ((tblAktionsplan LEFT JOIN BeobachtungenZdsf_AnzBeobProArt ON tblAktionsplan.ApArtId=BeobachtungenZdsf_AnzBeobProArt.ApArtId) INNER JOIN ArtenDb_tblFloraSisf ON tblAktionsplan.ApArtId=ArtenDb_tblFloraSisf.NR) LEFT JOIN qryZdsfAnzBeobProArtZugewiesen ON tblAktionsplan.ApArtId=qryZdsfAnzBeobProArtZugewiesen.ApArtId ORDER BY Concat(ArtenDb_tblFloraSisf.Name, If(ArtenDb_tblFloraSisf.Deutsch Is Not Null, Concat(" (", ArtenDb_tblFloraSisf.Deutsch, ")"),""), If(ArtenDb_tblFloraSisf.Status="A","",If(ArtenDb_tblFloraSisf.Status="S",". ACHTUNG: Synonym",If(ArtenDb_tblFloraSisf.Status="E",". ACHTUNG: in anderem Taxon eingeschlossener Name",If(ArtenDb_tblFloraSisf.Status="Z",". ACHTUNG: zusammenfassender Name",". ACHTUNG: unbekannter Status des Namens")))));



CREATE VIEW qryfrmZdsfBeobArtNichtOffizielle AS
SELECT ArtenDb_tblFloraSisf.NR, Concat(ArtenDb_tblFloraSisf.Name, If(ArtenDb_tblFloraSisf.Deutsch Is Not Null, Concat(" (", ArtenDb_tblFloraSisf.Deutsch, ")"),""), If(ArtenDb_tblFloraSisf.Status="A","",If(ArtenDb_tblFloraSisf.Status="S",". Synonym",If(ArtenDb_tblFloraSisf.Status="E",". ACHTUNG: in anderem Taxon eingeschlossener Name",If(ArtenDb_tblFloraSisf.Status="Z",". ACHTUNG: zusammenfassender Name",". ACHTUNG: unbekannter Status des Namens"))))) AS Artname, BeobachtungenZdsf_AnzBeobProArt.AnzahlZdsfBeob AS "Anz ZDSF-Beob", qryZdsfAnzBeobProArtZugewiesen.AnzahlZdsfBeobZugewiesen AS "Davon zugewiesen", ArtenDb_tblFloraSisf.OffizielleArt, ArtenDb_tblFloraSisf.Status
FROM tblKonstanten INNER JOIN ((qryZdsfAnzBeobProArtZugewiesen RIGHT JOIN ArtenDb_tblFloraSisf ON qryZdsfAnzBeobProArtZugewiesen.ApArtId = ArtenDb_tblFloraSisf.NR) LEFT JOIN BeobachtungenZdsf_AnzBeobProArt ON ArtenDb_tblFloraSisf.NR = BeobachtungenZdsf_AnzBeobProArt.ApArtId) ON tblKonstanten.frmZdsfBeobAlleAP = ArtenDb_tblFloraSisf.OffizielleArt
ORDER BY Concat(ArtenDb_tblFloraSisf.Name, If(ArtenDb_tblFloraSisf.Deutsch Is Not Null, Concat(" (", ArtenDb_tblFloraSisf.Deutsch, ")"),""), If(ArtenDb_tblFloraSisf.Status="A","",If(ArtenDb_tblFloraSisf.Status="S",". Synonym",If(ArtenDb_tblFloraSisf.Status="E",". ACHTUNG: in anderem Taxon eingeschlossener Name",If(ArtenDb_tblFloraSisf.Status="Z",". ACHTUNG: zusammenfassender Name",". ACHTUNG: unbekannter Status des Namens")))));



CREATE VIEW qryFrmAktionsplan_VARIANTE 1 AS 
SELECT tblAktionsplan.*, ArtenDb_tblFloraSisf.Name
FROM ArtenDb_tblFloraSisf INNER JOIN tblAktionsplan ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId
ORDER BY ArtenDb_tblFloraSisf.Name;

Beide Varianten sind nicht nötig - das Formular greift jetzt direkt auf die Tabelle. Bloss unklar, wie es richtig sortiert.

CREATE VIEW qryFrmAktionsplan_VARIANTE2, ZULETZT VERWENDET AS
SELECT tblAktionsplan.*, ArtenDb_tblFloraSisf.Name, ArtenDb_tblFloraFnsArtwert.AwArtwert AS Artwert
FROM (ArtenDb_tblFloraSisf INNER JOIN tblAktionsplan ON ArtenDb_tblFloraSisf.NR=tblAktionsplan.ApArtId) LEFT JOIN ArtenDb_tblFloraFnsArtwert ON ArtenDb_tblFloraSisf.NR=ArtenDb_tblFloraFnsArtwert.SisfNr
ORDER BY ArtenDb_tblFloraSisf.Name;

CREATE VIEW qryZdsfBeobAlle AS
SELECT BeobachtungenZdsf_ZdsfBeob.OBJECTID, BeobachtungenZdsf_ZdsfBeob.A, BeobachtungenZdsf_ZdsfBeob.Vk, BeobachtungenZdsf_ZdsfBeob.wFN, BeobachtungenZdsf_ZdsfBeob.FN, BeobachtungenZdsf_ZdsfBeob.xGIS, BeobachtungenZdsf_ZdsfBeob.yGIS, BeobachtungenZdsf_ZdsfBeob.ISFS, BeobachtungenZdsf_ZdsfBeob.NO_NOTE, BeobachtungenZdsf_ZdsfBeob.TY_NOTE, BeobachtungenZdsf_ZdsfBeob.NO_ISFS, BeobachtungenZdsf_ZdsfBeob.FAMILLE, BeobachtungenZdsf_ZdsfBeob.GENRE, BeobachtungenZdsf_ZdsfBeob.NOM_COMPLET, BeobachtungenZdsf_ZdsfBeob.NOM_PERSONNE_OBS, BeobachtungenZdsf_ZdsfBeob.PRENOM_PERSONNE_OBS, BeobachtungenZdsf_ZdsfBeob.PERSONNE_SEC, BeobachtungenZdsf_ZdsfBeob.J_NOTE, BeobachtungenZdsf_ZdsfBeob.M_NOTE, BeobachtungenZdsf_ZdsfBeob.A_NOTE, BeobachtungenZdsf_ZdsfBeob.ESTIMATION_DATE, BeobachtungenZdsf_ZdsfBeob.CO_CANTON, BeobachtungenZdsf_ZdsfBeob.NOM_COMMUNE, BeobachtungenZdsf_ZdsfBeob.EXPERTISE_COMMUNE, BeobachtungenZdsf_ZdsfBeob.DESC_LOCALITE, BeobachtungenZdsf_ZdsfBeob.COORDONNEE_FED_E, BeobachtungenZdsf_ZdsfBeob.COORDONNEE_FED_N, BeobachtungenZdsf_ZdsfBeob.PRECISION_MAILLE, BeobachtungenZdsf_ZdsfBeob.EXPERTISE_GEO, BeobachtungenZdsf_ZdsfBeob.NO_SURFACE_WELTEN, BeobachtungenZdsf_ZdsfBeob.EXPERTISE_WS, BeobachtungenZdsf_ZdsfBeob.HERBIER_WS, BeobachtungenZdsf_ZdsfBeob.ALTITUDE_INF, BeobachtungenZdsf_ZdsfBeob.ALTITUDE_SUP, BeobachtungenZdsf_ZdsfBeob.PRECISION_ALT, BeobachtungenZdsf_ZdsfBeob.CO_MILIEU, BeobachtungenZdsf_ZdsfBeob.STATION, BeobachtungenZdsf_ZdsfBeob.SUBSTRAT, BeobachtungenZdsf_ZdsfBeob.CAT_ABONDANCE, BeobachtungenZdsf_ZdsfBeob.ABONDANCE, BeobachtungenZdsf_ZdsfBeob.DETERMINAVIT, BeobachtungenZdsf_ZdsfBeob.DETERMINAVIT_CF, BeobachtungenZdsf_ZdsfBeob.REM_NOTE, BeobachtungenZdsf_ZdsfBeob.PRESENCE, BeobachtungenZdsf_ZdsfBeob.INTRODUIT, BeobachtungenZdsf_ZdsfBeob.MENACES, BeobachtungenZdsf_ZdsfBeob.MESURES, BeobachtungenZdsf_ZdsfBeob.TY_TEMOIN, BeobachtungenZdsf_ZdsfBeob.DEPOT_TEMOIN, BeobachtungenZdsf_ZdsfBeob.ID_TEMOIN, BeobachtungenZdsf_ZdsfBeob.EX_HERBIER, BeobachtungenZdsf_ZdsfBeob.NO_BIBLIO, BeobachtungenZdsf_ZdsfBeob.SOURCE_BIBLIO, BeobachtungenZdsf_ZdsfBeob.NO_BIBLIO_CITE, BeobachtungenZdsf_ZdsfBeob.SOURCE_BIBLIO_CITE, BeobachtungenZdsf_ZdsfBeob.NO_FORTSCHRITTE, BeobachtungenZdsf_ZdsfBeob.CONFIDENTIALITE, BeobachtungenZdsf_ZdsfBeob.PROJET, BeobachtungenZdsf_ZdsfBeob.NO_PROJET, BeobachtungenZdsf_ZdsfBeob.REM_PROJET, BeobachtungenZdsf_ZdsfBeob.REM_CRSF, BeobachtungenZdsf_ZdsfBeob.Autor, BeobachtungenZdsf_ZdsfBeob.lnkGisBrowser, tblKonstanten.frmZdsfBeobAlleArt, tblKonstanten.frmZdsfBeobAlleJahr
FROM BeobachtungenZdsf_ZdsfBeob INNER JOIN tblKonstanten ON BeobachtungenZdsf_ZdsfBeob.ISFS = tblKonstanten.frmZdsfBeobAlleArt
ORDER BY BeobachtungenZdsf_ZdsfBeob.CO_CANTON DESC , BeobachtungenZdsf_ZdsfBeob.NOM_COMMUNE, BeobachtungenZdsf_ZdsfBeob.DESC_LOCALITE;

CREATE VIEW qryZdsfBeobAlleJahr AS 
SELECT BeobachtungenZdsf_ZdsfBeob.OBJECTID, BeobachtungenZdsf_ZdsfBeob.A, BeobachtungenZdsf_ZdsfBeob.Vk, BeobachtungenZdsf_ZdsfBeob.wFN, BeobachtungenZdsf_ZdsfBeob.FN, BeobachtungenZdsf_ZdsfBeob.xGIS, BeobachtungenZdsf_ZdsfBeob.yGIS, BeobachtungenZdsf_ZdsfBeob.ISFS, BeobachtungenZdsf_ZdsfBeob.NO_NOTE, BeobachtungenZdsf_ZdsfBeob.TY_NOTE, BeobachtungenZdsf_ZdsfBeob.NO_ISFS, BeobachtungenZdsf_ZdsfBeob.FAMILLE, BeobachtungenZdsf_ZdsfBeob.GENRE, BeobachtungenZdsf_ZdsfBeob.NOM_COMPLET, BeobachtungenZdsf_ZdsfBeob.NOM_PERSONNE_OBS, BeobachtungenZdsf_ZdsfBeob.PRENOM_PERSONNE_OBS, BeobachtungenZdsf_ZdsfBeob.PERSONNE_SEC, BeobachtungenZdsf_ZdsfBeob.J_NOTE, BeobachtungenZdsf_ZdsfBeob.M_NOTE, BeobachtungenZdsf_ZdsfBeob.A_NOTE, BeobachtungenZdsf_ZdsfBeob.ESTIMATION_DATE, BeobachtungenZdsf_ZdsfBeob.CO_CANTON, BeobachtungenZdsf_ZdsfBeob.NOM_COMMUNE, BeobachtungenZdsf_ZdsfBeob.EXPERTISE_COMMUNE, BeobachtungenZdsf_ZdsfBeob.DESC_LOCALITE, BeobachtungenZdsf_ZdsfBeob.COORDONNEE_FED_E, BeobachtungenZdsf_ZdsfBeob.COORDONNEE_FED_N, BeobachtungenZdsf_ZdsfBeob.PRECISION_MAILLE, BeobachtungenZdsf_ZdsfBeob.EXPERTISE_GEO, BeobachtungenZdsf_ZdsfBeob.NO_SURFACE_WELTEN, BeobachtungenZdsf_ZdsfBeob.EXPERTISE_WS, BeobachtungenZdsf_ZdsfBeob.HERBIER_WS, BeobachtungenZdsf_ZdsfBeob.ALTITUDE_INF, BeobachtungenZdsf_ZdsfBeob.ALTITUDE_SUP, BeobachtungenZdsf_ZdsfBeob.PRECISION_ALT, BeobachtungenZdsf_ZdsfBeob.CO_MILIEU, BeobachtungenZdsf_ZdsfBeob.STATION, BeobachtungenZdsf_ZdsfBeob.SUBSTRAT, BeobachtungenZdsf_ZdsfBeob.CAT_ABONDANCE, BeobachtungenZdsf_ZdsfBeob.ABONDANCE, BeobachtungenZdsf_ZdsfBeob.DETERMINAVIT, BeobachtungenZdsf_ZdsfBeob.DETERMINAVIT_CF, BeobachtungenZdsf_ZdsfBeob.REM_NOTE, BeobachtungenZdsf_ZdsfBeob.PRESENCE, BeobachtungenZdsf_ZdsfBeob.INTRODUIT, BeobachtungenZdsf_ZdsfBeob.MENACES, BeobachtungenZdsf_ZdsfBeob.MESURES, BeobachtungenZdsf_ZdsfBeob.TY_TEMOIN, BeobachtungenZdsf_ZdsfBeob.DEPOT_TEMOIN, BeobachtungenZdsf_ZdsfBeob.ID_TEMOIN, BeobachtungenZdsf_ZdsfBeob.EX_HERBIER, BeobachtungenZdsf_ZdsfBeob.NO_BIBLIO, BeobachtungenZdsf_ZdsfBeob.SOURCE_BIBLIO, BeobachtungenZdsf_ZdsfBeob.NO_BIBLIO_CITE, BeobachtungenZdsf_ZdsfBeob.SOURCE_BIBLIO_CITE, BeobachtungenZdsf_ZdsfBeob.NO_FORTSCHRITTE, BeobachtungenZdsf_ZdsfBeob.CONFIDENTIALITE, BeobachtungenZdsf_ZdsfBeob.PROJET, BeobachtungenZdsf_ZdsfBeob.NO_PROJET, BeobachtungenZdsf_ZdsfBeob.REM_PROJET, BeobachtungenZdsf_ZdsfBeob.REM_CRSF, BeobachtungenZdsf_ZdsfBeob.Autor, BeobachtungenZdsf_ZdsfBeob.lnkGisBrowser, tblKonstanten.frmZdsfBeobAlleArt, tblKonstanten.frmZdsfBeobAlleJahr
FROM BeobachtungenZdsf_ZdsfBeob INNER JOIN tblKonstanten ON (BeobachtungenZdsf_ZdsfBeob.ISFS = tblKonstanten.frmZdsfBeobAlleArt) AND (BeobachtungenZdsf_ZdsfBeob.A_NOTE = tblKonstanten.frmZdsfBeobAlleJahr)
ORDER BY BeobachtungenZdsf_ZdsfBeob.CO_CANTON DESC , BeobachtungenZdsf_ZdsfBeob.NOM_COMMUNE, BeobachtungenZdsf_ZdsfBeob.DESC_LOCALITE;

CREATE VIEW qryZdsfBeobAlleNachDistZuTPop AS
SELECT BeobachtungenZdsf_ZdsfBeob.OBJECTID, BeobachtungenZdsf_ZdsfBeob.A, BeobachtungenZdsf_ZdsfBeob.Vk, BeobachtungenZdsf_ZdsfBeob.wFN, BeobachtungenZdsf_ZdsfBeob.FN, BeobachtungenZdsf_ZdsfBeob.xGIS, BeobachtungenZdsf_ZdsfBeob.yGIS, SQRT((BeobachtungenZdsf_ZdsfBeob.xGis-tblKonstanten.YKoord)*(BeobachtungenZdsf_ZdsfBeob.xGis-tblKonstanten.YKoord)+(BeobachtungenZdsf_ZdsfBeob.yGis-tblKonstanten.XKoord)*(BeobachtungenZdsf_ZdsfBeob.yGis-tblKonstanten.XKoord)) AS DistanzZurTPop_m, BeobachtungenZdsf_ZdsfBeob.ISFS, BeobachtungenZdsf_ZdsfBeob.NO_NOTE, BeobachtungenZdsf_ZdsfBeob.TY_NOTE, BeobachtungenZdsf_ZdsfBeob.NO_ISFS, BeobachtungenZdsf_ZdsfBeob.FAMILLE, BeobachtungenZdsf_ZdsfBeob.GENRE, BeobachtungenZdsf_ZdsfBeob.NOM_COMPLET, BeobachtungenZdsf_ZdsfBeob.NOM_PERSONNE_OBS, BeobachtungenZdsf_ZdsfBeob.PRENOM_PERSONNE_OBS, BeobachtungenZdsf_ZdsfBeob.PERSONNE_SEC, BeobachtungenZdsf_ZdsfBeob.J_NOTE, BeobachtungenZdsf_ZdsfBeob.M_NOTE, BeobachtungenZdsf_ZdsfBeob.A_NOTE, BeobachtungenZdsf_ZdsfBeob.ESTIMATION_DATE, BeobachtungenZdsf_ZdsfBeob.CO_CANTON, BeobachtungenZdsf_ZdsfBeob.NOM_COMMUNE, BeobachtungenZdsf_ZdsfBeob.EXPERTISE_COMMUNE, BeobachtungenZdsf_ZdsfBeob.DESC_LOCALITE, BeobachtungenZdsf_ZdsfBeob.COORDONNEE_FED_E, BeobachtungenZdsf_ZdsfBeob.COORDONNEE_FED_N, BeobachtungenZdsf_ZdsfBeob.PRECISION_MAILLE, BeobachtungenZdsf_ZdsfBeob.EXPERTISE_GEO, BeobachtungenZdsf_ZdsfBeob.NO_SURFACE_WELTEN, BeobachtungenZdsf_ZdsfBeob.EXPERTISE_WS, BeobachtungenZdsf_ZdsfBeob.HERBIER_WS, BeobachtungenZdsf_ZdsfBeob.ALTITUDE_INF, BeobachtungenZdsf_ZdsfBeob.ALTITUDE_SUP, BeobachtungenZdsf_ZdsfBeob.PRECISION_ALT, BeobachtungenZdsf_ZdsfBeob.CO_MILIEU, BeobachtungenZdsf_ZdsfBeob.STATION, BeobachtungenZdsf_ZdsfBeob.SUBSTRAT, BeobachtungenZdsf_ZdsfBeob.CAT_ABONDANCE, BeobachtungenZdsf_ZdsfBeob.ABONDANCE, BeobachtungenZdsf_ZdsfBeob.DETERMINAVIT, BeobachtungenZdsf_ZdsfBeob.DETERMINAVIT_CF, BeobachtungenZdsf_ZdsfBeob.REM_NOTE, BeobachtungenZdsf_ZdsfBeob.PRESENCE, BeobachtungenZdsf_ZdsfBeob.INTRODUIT, BeobachtungenZdsf_ZdsfBeob.MENACES, BeobachtungenZdsf_ZdsfBeob.MESURES, BeobachtungenZdsf_ZdsfBeob.TY_TEMOIN, BeobachtungenZdsf_ZdsfBeob.DEPOT_TEMOIN, BeobachtungenZdsf_ZdsfBeob.ID_TEMOIN, BeobachtungenZdsf_ZdsfBeob.EX_HERBIER, BeobachtungenZdsf_ZdsfBeob.NO_BIBLIO, BeobachtungenZdsf_ZdsfBeob.SOURCE_BIBLIO, BeobachtungenZdsf_ZdsfBeob.NO_BIBLIO_CITE, BeobachtungenZdsf_ZdsfBeob.SOURCE_BIBLIO_CITE, BeobachtungenZdsf_ZdsfBeob.NO_FORTSCHRITTE, BeobachtungenZdsf_ZdsfBeob.CONFIDENTIALITE, BeobachtungenZdsf_ZdsfBeob.PROJET, BeobachtungenZdsf_ZdsfBeob.NO_PROJET, BeobachtungenZdsf_ZdsfBeob.REM_PROJET, BeobachtungenZdsf_ZdsfBeob.REM_CRSF, BeobachtungenZdsf_ZdsfBeob.Autor, BeobachtungenZdsf_ZdsfBeob.lnkGisBrowser, tblKonstanten.frmZdsfBeobAlleArt, tblKonstanten.frmZdsfBeobAlleJahr, tblKonstanten.TPopId
FROM BeobachtungenZdsf_ZdsfBeob INNER JOIN tblKonstanten ON BeobachtungenZdsf_ZdsfBeob.ISFS = tblKonstanten.frmZdsfBeobAlleArt
ORDER BY SQRT((BeobachtungenZdsf_ZdsfBeob.xGis-tblKonstanten.YKoord)*(BeobachtungenZdsf_ZdsfBeob.xGis-tblKonstanten.YKoord)+(BeobachtungenZdsf_ZdsfBeob.yGis-tblKonstanten.XKoord)*(BeobachtungenZdsf_ZdsfBeob.yGis-tblKonstanten.XKoord));

CREATE VIEW qryZdsfAnzBeobProArt_zuweisen AS 
SELECT BeobachtungenZdsf_AnzBeobProArt.AnzahlZdsfBeob
FROM tblKonstanten INNER JOIN BeobachtungenZdsf_AnzBeobProArt ON tblKonstanten.frmZdsfBeobAlleArt = BeobachtungenZdsf_AnzBeobProArt.ApArtId;

CREATE VIEW qryAuswFreiwKontrAnzBestJahr01 AS 
SELECT ArtenDb_tblFloraSisf.Name, DomainApBearbeitungsstand.DomainTxt AS BearbeitungsstandAp, tblTeilPopFeldkontrolle.TPopKontrJahr, tblTeilPopFeldkontrolle.TPopKontrTyp, DomainTPopKontrZaehleinheit.ZaehleinheitTxt AS Zähleinheit, tblTeilPopFeldkontrolle.TPopKontrAnz1 AS Anzahl
