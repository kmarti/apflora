...
window.apf.erstelle_tree = function(ApArtId) {
	...
	var jstree_erstellt = $.Deferred(),
        treeKontextmenu = require('./modules/treeKontextmenu');
	$("#tree").jstree({
		"json_data": {
			"ajax": {
...
},{"./modules/configuration":6,"./modules/initiiereBeob":8,"./modules/initiiereIdealbiotop":9,"./modules/treeKontextmenu":10}],2:[function(require,module,exports){
/*
 * Date Format 1.2.3
...
},{"./dbPass.json":7}],7:[function(require,module,exports){
module.exports={
    "user": "alexande",
...
var initiiereBeob = function(beobTyp, beobId, beobStatus, ohneZuZeigen) {
    ...
    getBeob.done(function(data_beob) {
        ...
        if (data_beob && data_beob.length > 0) {
            ...
            url_distzutpop = 'api/beobDistzutpop' + capitaliseFirstLetter(beobTyp) + '/beobId=' + beobId;
...
},{"../lib/capitaliseFirstLetter":5,"jquery":3,"underscore":4}],9:[function(require,module,exports){
'use strict';
...
},{"dateformat":2,"jquery":3}],10:[function(require,module,exports){
'use strict';
