...
if (isset($_GET["apart_id"])) {
    $apart_id = $_GET["apart_id"];
    settype($apart_id, "integer");
}
if (isset($_GET["beobid"])) {
    $beobid = $_GET["beobid"];
}
if (isset($_GET["tpop_id"])) {
    $tpop_id = $_GET["tpop_id"];
    settype($tpop_id, "integer");
}
if (isset($_GET["nicht_zuzuordnen"])) {
...
} else if (isset($apart_id)) {
	// apart_id wurde übergeben > auf Art filtern 
	if (isset($nicht_zuzuordnen)) {
