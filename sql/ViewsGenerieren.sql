...
CREATE VIEW vTeilpopulationen AS
...
CREATE VIEW vTeilpopulationenFuerGis AS
SELECT ArtenDb_tblFloraSisf.NR AS ApArtId, ArtenDb_tblFloraSisf.Name AS Artname, DomainApBearbeitungsstand.DomainTxt AS ApStatus, tblAktionsplan.ApJahr, DomainApUmsetzung.DomainTxt AS ApUmsetzungsstand, tblPopulation.PopGuid, tblPopulation.PopNr, tblPopulation.PopName, DomainPopHerkunft.HerkunftTxt AS PopHerkunft, tblPopulation.PopBekanntSeit, tblTeilpopulation.TPopGuid, tblTeilpopulation.TPopNr, tblTeilpopulation.TPopGemeinde, tblTeilpopulation.TPopFlurname, tblTeilpopulation.TPopXKoord, tblTeilpopulation.TPopYKoord, tblTeilpopulation.TPopRadius, tblTeilpopulation.TPopHoehe, tblTeilpopulation.TPopExposition, tblTeilpopulation.TPopKlima, tblTeilpopulation.TPopNeigung, tblTeilpopulation.TPopBeschr, tblTeilpopulation.TPopKatNr, tblAdresse.AdrName AS TPopVerantw, DomainPopHerkunft_1.HerkunftTxt AS TPopHerkunft, tblTeilpopulation.TPopHerkunftUnklarBegruendung, tblTeilpopulation.TPopApBerichtRelevant, tblTeilpopulation.TPopBekanntSeit, tblTeilpopulation.TPopEigen, tblTeilpopulation.TPopKontakt, tblTeilpopulation.TPopNutzungszone, tblTeilpopulation.TPopBewirtschafterIn, tblTeilpopulation.TPopBewirtschaftung, tblTeilpopulation.TPopPop, tblTeilpopulation.MutWann, tblTeilpopulation.MutWer
FROM ((((((ArtenDb_tblFloraSisf INNER JOIN tblAktionsplan ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) INNER JOIN (tblPopulation INNER JOIN tblTeilpopulation ON tblPopulation.PopId = tblTeilpopulation.PopId) ON tblAktionsplan.ApArtId = tblPopulation.ApArtId) LEFT JOIN DomainApBearbeitungsstand ON tblAktionsplan.ApStatus = DomainApBearbeitungsstand.DomainCode) LEFT JOIN DomainApUmsetzung ON tblAktionsplan.ApUmsetzung = DomainApUmsetzung.DomainCode) LEFT JOIN DomainPopHerkunft ON tblPopulation.PopHerkunft = DomainPopHerkunft.HerkunftId) LEFT JOIN DomainPopHerkunft AS DomainPopHerkunft_1 ON tblTeilpopulation.TPopHerkunft = DomainPopHerkunft_1.HerkunftId) INNER JOIN tblAdresse ON tblTeilpopulation.TPopVerantw = tblAdresse.AdrId
ORDER BY ArtenDb_tblFloraSisf.Name, tblPopulation.PopNr, tblTeilpopulation.TPopNr;
...
CREATE VIEW vKontrPopMassnBerichteOhneMassnahmenTPopMassn0 AS 
...
CREATE VIEW vKontrPopMassnBerichteOhneMassahmen AS 
SELECT ArtenDb_tblFloraSisf.Name, tblPopulation.PopNr, tblPopulation.PopName, tblPopMassnBericht.PopMassnBerJahr
FROM (tblAktionsplan INNER JOIN ArtenDb_tblFloraSisf ON tblAktionsplan.ApArtId = ArtenDb_tblFloraSisf.NR) INNER JOIN ((tblPopulation INNER JOIN tblPopMassnBericht ON tblPopulation.PopId = tblPopMassnBericht.PopId) LEFT JOIN (tblTeilpopulation LEFT JOIN vKontrPopMassnBerichteOhneMassnahmenTPopMassn0 ON tblTeilpopulation.TPopId = vKontrPopMassnBerichteOhneMassnahmenTPopMassn0.TPopId) ON tblPopulation.PopId = tblTeilpopulation.PopId) ON tblAktionsplan.ApArtId = tblPopulation.ApArtId
WHERE (((tblPopMassnBericht.PopMassnBerJahr)>=tblAktionsplan.ApJahr) AND ((vKontrPopMassnBerichteOhneMassnahmenTPopMassn0.TPopId) Is Null) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
...
FROM (tblAktionsplan INNER JOIN ArtenDb_tblFloraSisf ON tblAktionsplan.ApArtId = ArtenDb_tblFloraSisf.NR) INNER JOIN ((tblPopulation INNER JOIN (tblTeilpopulation LEFT JOIN vKontrPopMassnBerichteOhneMassnahmenTPopMassn0 ON tblTeilpopulation.TPopId = vKontrPopMassnBerichteOhneMassnahmenTPopMassn0.TPopId) ON tblPopulation.PopId = tblTeilpopulation.PopId) INNER JOIN tblTeilPopMassnBericht ON tblTeilpopulation.TPopId = tblTeilPopMassnBericht.TPopId) ON tblAktionsplan.ApArtId = tblPopulation.ApArtId
WHERE (((tblTeilPopMassnBericht.TPopMassnBerJahr)>=tblAktionsplan.ApJahr) AND ((vKontrPopMassnBerichteOhneMassnahmenTPopMassn0.TPopId) Is Null) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
...
SELECT vApAnzMassnProJahr.ApArtId, vApAnzMassnProJahr.TPopMassnJahr, Sum(vApAnzMassnProJahr_1.AnzahlvonTPopMassnId) AS "SummevonAnzahlvonTPopMassnId"
...
SELECT tblApBericht.*, CAST(If(ArtenDb_tblFloraSisf.Deutsch is null,ArtenDb_tblFloraSisf.Name, CONCAT(ArtenDb_tblFloraSisf.Name, ' (', ArtenDb_tblFloraSisf.Deutsch, ')')) AS CHAR) AS Artname, If(ArtenDb_tblFloraFnsKef.KefArt=-1,"Ja","") AS FnsKefArt2, ArtenDb_tblFloraFnsKef.KefKontrolljahr, If(Round((tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,0)=(tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,"Ja","") AS FnsKefKontrJahr2, vFnsJahrespflanzen.Jahr AS FnsJahrespflanze, vFnsJahrespflanzen.Jahresart AS FnsJahrespflanze2, vAnzMassnProArtBisJahr.AnzahlMassnahmen
FROM (((ArtenDb_tblFloraSisf INNER JOIN (tblAktionsplan INNER JOIN vApApBerichtRelevant ON tblAktionsplan.ApArtId = vApApBerichtRelevant.ApArtId) ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) LEFT JOIN ArtenDb_tblFloraFnsKef ON tblAktionsplan.ApArtId = ArtenDb_tblFloraFnsKef.SisfNr) LEFT JOIN vFnsJahrespflanzen ON tblAktionsplan.ApArtId = vFnsJahrespflanzen.SisfNr) INNER JOIN (tblKonstanten INNER JOIN (tblApBericht INNER JOIN vAnzMassnProArtBisJahr ON tblApBericht.ApArtId = vAnzMassnProArtBisJahr.ApArtId) ON tblKonstanten.ApBerJahr = tblApBericht.ApBerJahr) ON tblAktionsplan.ApArtId = tblApBericht.ApArtId
WHERE ((vAnzMassnProArtBisJahr.AnzahlMassnahmen>0) AND (tblApBericht.ApBerBeurteilung=1) AND (tblAktionsplan.ApStatus Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;
...
FROM ((((ArtenDb_tblFloraSisf INNER JOIN ((vAnzMassnProArtBisJahr AS vAnzMassnProArtBisJahr_1 RIGHT JOIN tblAktionsplan ON vAnzMassnProArtBisJahr_1.ApArtId = tblAktionsplan.ApArtId) INNER JOIN vApApBerichtRelevant ON tblAktionsplan.ApArtId = vApApBerichtRelevant.ApArtId) ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) LEFT JOIN ArtenDb_tblFloraFnsJahresarten ON tblAktionsplan.ApArtId = ArtenDb_tblFloraFnsJahresarten.SisfNr) LEFT JOIN ArtenDb_tblFloraFnsKef ON tblAktionsplan.ApArtId = ArtenDb_tblFloraFnsKef.SisfNr) LEFT JOIN vFnsJahrespflanzen ON tblAktionsplan.ApArtId = vFnsJahrespflanzen.SisfNr) INNER JOIN (tblApBericht INNER JOIN tblKonstanten ON tblApBericht.ApBerJahr = tblKonstanten.ApBerJahr) ON tblAktionsplan.ApArtId = tblApBericht.ApArtId
WHERE ((tblAktionsplan.ApStatus Between 1 And 3) AND (vAnzMassnProArtBisJahr_1.AnzahlMassnahmen=0)) OR ((tblAktionsplan.ApStatus Between 1 And 3) AND (vAnzMassnProArtBisJahr_1.AnzahlMassnahmen Is Null))
ORDER BY ArtenDb_tblFloraSisf.Name;

CREATE VIEW vJbUebMa AS 
SELECT If(ArtenDb_tblFloraSisf.Deutsch is null,ArtenDb_tblFloraSisf.Name, CONCAT(ArtenDb_tblFloraSisf.Name, ' (', ArtenDb_tblFloraSisf.Deutsch, ')')) AS Artname, vAnzMassnProArtBisJahr.AnzahlMassnahmen
FROM (ArtenDb_tblFloraSisf INNER JOIN (tblAktionsplan INNER JOIN vApApBerichtRelevant ON tblAktionsplan.ApArtId = vApApBerichtRelevant.ApArtId) ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) INNER JOIN vAnzMassnProArtBisJahr ON tblAktionsplan.ApArtId = vAnzMassnProArtBisJahr.ApArtId
WHERE ((vAnzMassnProArtBisJahr.AnzahlMassnahmen>0) AND (tblAktionsplan.ApStatus Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;
...
FROM (((ArtenDb_tblFloraSisf INNER JOIN (tblAktionsplan INNER JOIN vApApBerichtRelevant ON tblAktionsplan.ApArtId = vApApBerichtRelevant.ApArtId) ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) LEFT JOIN vFnsJahrespflanzen ON tblAktionsplan.ApArtId = vFnsJahrespflanzen.SisfNr) INNER JOIN ((tblApBericht INNER JOIN vAnzMassnProArtBisJahr ON tblApBericht.ApArtId = vAnzMassnProArtBisJahr.ApArtId) INNER JOIN tblKonstanten ON tblApBericht.ApBerJahr = tblKonstanten.ApBerJahr) ON tblAktionsplan.ApArtId = tblApBericht.ApArtId) LEFT JOIN ArtenDb_tblFloraFnsKef ON ArtenDb_tblFloraSisf.NR = ArtenDb_tblFloraFnsKef.SisfNr
WHERE (((tblApBericht.ApBerBeurteilung)=5) AND ((vAnzMassnProArtBisJahr.AnzahlMassnahmen)>0) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;

CREATE VIEW vJbUebNe AS
SELECT tblApBericht.*, If(ArtenDb_tblFloraSisf.Deutsch is null,ArtenDb_tblFloraSisf.Name, CONCAT(ArtenDb_tblFloraSisf.Name, ' (', ArtenDb_tblFloraSisf.Deutsch, ')')) AS Artname, If(ArtenDb_tblFloraFnsKef.KefArt=-1,"Ja","") AS FnsKefArt2, If(Round((tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,0)=(tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,"Ja","") AS FnsKefKontrJahr2, vFnsJahrespflanzen.Jahr AS FnsJahrespflanze, vFnsJahrespflanzen.Jahresart AS FnsJahrespflanze2
FROM ((((ArtenDb_tblFloraSisf INNER JOIN (tblAktionsplan INNER JOIN vApApBerichtRelevant ON tblAktionsplan.ApArtId = vApApBerichtRelevant.ApArtId) ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) LEFT JOIN vFnsJahrespflanzen ON tblAktionsplan.ApArtId = vFnsJahrespflanzen.SisfNr) LEFT JOIN ArtenDb_tblFloraFnsJahresarten ON ArtenDb_tblFloraSisf.NR = ArtenDb_tblFloraFnsJahresarten.SisfNr) LEFT JOIN ArtenDb_tblFloraFnsKef ON ArtenDb_tblFloraSisf.NR = ArtenDb_tblFloraFnsKef.SisfNr) INNER JOIN (((tblApBericht INNER JOIN vAnzMassnProArtBisJahr ON tblApBericht.ApArtId = vAnzMassnProArtBisJahr.ApArtId) INNER JOIN tblKonstanten ON tblApBericht.ApBerJahr = tblKonstanten.ApBerJahr) INNER JOIN tblKonstanten AS tblKonstanten_1 ON tblApBericht.ApBerJahr = tblKonstanten_1.ApBerJahr) ON tblAktionsplan.ApArtId = tblApBericht.ApArtId
WHERE (tblApBericht.ApBerBeurteilung=3 AND (tblAktionsplan.ApStatus Between 1 And 3) AND (vAnzMassnProArtBisJahr.AnzahlMassnahmen>0))
ORDER BY ArtenDb_tblFloraSisf.Name;

CREATE VIEW vJbUebSe AS 
SELECT tblApBericht.*, If(ArtenDb_tblFloraSisf.Deutsch is null,ArtenDb_tblFloraSisf.Name, CONCAT(ArtenDb_tblFloraSisf.Name, ' (', ArtenDb_tblFloraSisf.Deutsch, ')')) AS Artname, If(ArtenDb_tblFloraFnsKef.KefArt=-1,"Ja","") AS FnsKefArt2, If(Round((tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,0)=(tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,"Ja","") AS FnsKefKontrJahr2, vFnsJahrespflanzen.Jahr AS FnsJahrespflanze, vFnsJahrespflanzen.Jahresart AS FnsJahrespflanze2
FROM (((ArtenDb_tblFloraSisf INNER JOIN (tblAktionsplan INNER JOIN vApApBerichtRelevant ON tblAktionsplan.ApArtId = vApApBerichtRelevant.ApArtId) ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) LEFT JOIN vFnsJahrespflanzen ON tblAktionsplan.ApArtId = vFnsJahrespflanzen.SisfNr) LEFT JOIN ArtenDb_tblFloraFnsKef ON ArtenDb_tblFloraSisf.NR = ArtenDb_tblFloraFnsKef.SisfNr) INNER JOIN ((tblApBericht INNER JOIN vAnzMassnProArtBisJahr ON tblApBericht.ApArtId = vAnzMassnProArtBisJahr.ApArtId) INNER JOIN tblKonstanten ON tblApBericht.ApBerJahr = tblKonstanten.ApBerJahr) ON tblAktionsplan.ApArtId = tblApBericht.ApArtId
WHERE (((tblApBericht.ApBerBeurteilung)=4) AND ((vAnzMassnProArtBisJahr.AnzahlMassnahmen)>0) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;

CREATE VIEW vJbUebUn AS 
SELECT tblApBericht.*, If(ArtenDb_tblFloraSisf.Deutsch is null,ArtenDb_tblFloraSisf.Name, CONCAT(ArtenDb_tblFloraSisf.Name, ' (', ArtenDb_tblFloraSisf.Deutsch, ')')) AS Artname, If(ArtenDb_tblFloraFnsKef.KefArt=-1,"Ja","") AS FnsKefArt2, If(Round((tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,0)=(tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,"Ja","") AS FnsKefKontrJahr2, vFnsJahrespflanzen.Jahr AS FnsJahrespflanze, vFnsJahrespflanzen.Jahresart AS FnsJahrespflanze2
FROM (((ArtenDb_tblFloraSisf INNER JOIN (tblAktionsplan INNER JOIN vApApBerichtRelevant ON tblAktionsplan.ApArtId = vApApBerichtRelevant.ApArtId) ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) LEFT JOIN vFnsJahrespflanzen ON tblAktionsplan.ApArtId = vFnsJahrespflanzen.SisfNr) LEFT JOIN ArtenDb_tblFloraFnsKef ON ArtenDb_tblFloraSisf.NR = ArtenDb_tblFloraFnsKef.SisfNr) INNER JOIN ((tblApBericht INNER JOIN vAnzMassnProArtBisJahr ON tblApBericht.ApArtId = vAnzMassnProArtBisJahr.ApArtId) INNER JOIN tblKonstanten ON tblApBericht.ApBerJahr = tblKonstanten.ApBerJahr) ON tblAktionsplan.ApArtId = tblApBericht.ApArtId
WHERE (((tblApBericht.ApBerBeurteilung)=1168274204) AND ((vAnzMassnProArtBisJahr.AnzahlMassnahmen)>0) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;

CREATE VIEW vJbUebWe AS 
SELECT tblApBericht.*, If(ArtenDb_tblFloraSisf.Deutsch is null,ArtenDb_tblFloraSisf.Name, CONCAT(ArtenDb_tblFloraSisf.Name, ' (', ArtenDb_tblFloraSisf.Deutsch, ')')) AS Artname, If(ArtenDb_tblFloraFnsKef.KefArt=-1,"Ja","") AS FnsKefArt2, If(Round((tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,0)=(tblKonstanten.ApBerJahr-ArtenDb_tblFloraFnsKef.KefKontrolljahr)/4,"Ja","") AS FnsKefKontrJahr2, vFnsJahrespflanzen.Jahr AS FnsJahrespflanze, vFnsJahrespflanzen.Jahresart AS FnsJahrespflanze2
FROM (((ArtenDb_tblFloraSisf INNER JOIN (tblAktionsplan INNER JOIN vApApBerichtRelevant ON tblAktionsplan.ApArtId = vApApBerichtRelevant.ApArtId) ON ArtenDb_tblFloraSisf.NR = tblAktionsplan.ApArtId) LEFT JOIN vFnsJahrespflanzen ON tblAktionsplan.ApArtId = vFnsJahrespflanzen.SisfNr) LEFT JOIN ArtenDb_tblFloraFnsKef ON ArtenDb_tblFloraSisf.NR = ArtenDb_tblFloraFnsKef.SisfNr) INNER JOIN ((tblApBericht INNER JOIN vAnzMassnProArtBisJahr ON tblApBericht.ApArtId = vAnzMassnProArtBisJahr.ApArtId) INNER JOIN tblKonstanten ON tblApBericht.ApBerJahr = tblKonstanten.ApBerJahr) ON tblAktionsplan.ApArtId = tblApBericht.ApArtId
WHERE (((tblApBericht.ApBerBeurteilung)=6) AND ((vAnzMassnProArtBisJahr.AnzahlMassnahmen)>0) AND ((tblAktionsplan.ApStatus) Between 1 And 3))
ORDER BY ArtenDb_tblFloraSisf.Name;

CREATE VIEW vJbUebNichtBeurteilt000 AS 
SELECT tblAktionsplan.ApArtId
FROM ((tblAktionsplan INNER JOIN vAnzMassnProArtBisJahr ON tblAktionsplan.ApArtId = vAnzMassnProArtBisJahr.ApArtId) INNER JOIN vApApBerichtRelevant ON tblAktionsplan.ApArtId = vApApBerichtRelevant.ApArtId) LEFT JOIN tblApBericht ON tblAktionsplan.ApArtId = tblApBericht.ApArtId
WHERE ((tblApBericht.ApArtId Is Null) AND (tblAktionsplan.ApStatus Between 1 And 3));

CREATE VIEW vJbUebNichtBeurteilt00 AS 
SELECT tblAktionsplan.ApArtId
FROM ((tblAktionsplan INNER JOIN vAnzMassnProArtBisJahr ON tblAktionsplan.ApArtId = vAnzMassnProArtBisJahr.ApArtId) INNER JOIN vApApBerichtRelevant ON tblAktionsplan.ApArtId = vApApBerichtRelevant.ApArtId) INNER JOIN (tblApBericht INNER JOIN tblKonstanten ON tblApBericht.ApBerJahr = tblKonstanten.ApBerJahr) ON tblAktionsplan.ApArtId = tblApBericht.ApArtId
...
CREATE VIEW vKontrTPopPopFehlt AS 
...
CREATE VIEW vAuswApArtenAnzKontrInJahr0 AS
