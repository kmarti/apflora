...
simple, insert:
INSERT INTO tblTeilPopMassnPolygon (TPopMassnGuid, TPopMassnPolygonPolygon) SELECT tblTeilPopMassnahme.TPopMassnGuid, PolygonFromText(CONCAT('Polygon((', CAST(TPopXKoord AS DECIMAL(10,0)), ' ',  CAST(TPopYKoord AS DECIMAL(10,0)), ',', CAST(TPopXKoord+50 AS DECIMAL(10,0)), ' ',  CAST(TPopYKoord AS DECIMAL(10,0)), ',', CAST(TPopXKoord+50 AS DECIMAL(10,0)), ' ',  CAST(TPopYKoord+50 AS DECIMAL(10,0)), ',', CAST(TPopXKoord AS DECIMAL(10,0)), ' ',  CAST(TPopYKoord AS DECIMAL(10,0)), '))')) FROM tblTeilpopulation INNER JOIN tblTeilPopMassnahme ON tblTeilpopulation.TPopId = tblTeilPopMassnahme.TPopId WHERE TPopXKoord > 0 AND TPopYKoord > 0

INSERT INTO tblTeilPopMassnLine (TPopMassnGuid, TPopMassnLineLine) SELECT tblTeilPopMassnahme.TPopMassnGuid, GeomFromText(CONCAT('LineString(', CAST(TPopXKoord AS DECIMAL(10,0)), ' ',  CAST(TPopYKoord AS DECIMAL(10,0)), ',', CAST(TPopXKoord+50 AS DECIMAL(10,0)), ' ',  CAST(TPopYKoord AS DECIMAL(10,0)), ',', CAST(TPopXKoord+50 AS DECIMAL(10,0)), ' ',  CAST(TPopYKoord+50 AS DECIMAL(10,0)), ')')) FROM tblTeilpopulation INNER JOIN tblTeilPopMassnahme ON tblTeilpopulation.TPopId = tblTeilPopMassnahme.TPopId WHERE TPopXKoord > 0 AND TPopYKoord > 0

INSERT INTO tblTeilPopMassnPoint (TPopMassnGuid, TPopMassnPointPoint) SELECT tblTeilPopMassnahme.TPopMassnGuid, GeomFromText(CONCAT('Point(', CAST(TPopXKoord AS DECIMAL(10,0)), ' ',  CAST(TPopYKoord AS DECIMAL(10,0)), ')')) FROM tblTeilpopulation INNER JOIN tblTeilPopMassnahme ON tblTeilpopulation.TPopId = tblTeilPopMassnahme.TPopId WHERE TPopXKoord > 0 AND TPopYKoord > 0
